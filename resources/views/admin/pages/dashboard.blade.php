...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card frappe_Gantt">
                    <div class="card-body pb-0">
                        <h4 class="card-title mb-4">📅 專案進度 Gantt 圖我是Frappe Gantt</h4>
                    </div>
                    <div class="card-body py-0 px-2">
                        <div id="gantt"></div>
                    </div>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body pb-0">
                        <h4 class="card-title mb-4">我是Apexcharts Gantt</h4>
                    </div>
                    <div class="card-body py-0 px-2">
                        <div id="gantt_chart" class="apex-charts" dir="ltr"></div>
                    </div>
                </div>
            </div>
        </div>
