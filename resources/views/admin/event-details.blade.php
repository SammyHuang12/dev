...
<div class="page-content">
    <div class="container-fluid position-relative">
        ...
        <div class="custom-fixed">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="button-items mb-3 w-100">
        ...
        <div class="row custom-m-top">
            ...
            <!-- Star content-rightSide bar  -->
            <div class="col-md-4">
                @include('admin.components.content-rightSidebar')
            </div>
            <!-- End content-rightSide bar -->
        </div>
        <!-- end row -->
