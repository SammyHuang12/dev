                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">招募人選資料細項(不要input)</h4>
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">招募人選</a></li>
                                    <li class="breadcrumb-item active">招募人選細項</li>
                                </ol>
                            </div>
                        </div>
                        <div class="button-items mb-3">
                            <button type="button" id="formsend"
                                class="btn btn-primary waves-effect waves-light">儲存送出</button>
                            <button type="button" id="create_event"
                                class="btn btn-info waves-light waves-effect">新增客面歷程</button>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="row row-cols-md-2 row-cols-1">
                                                        <div class="col">
                                                            <dl class="row mb-0">
                                                                <dt class="col-4">面試人選編號</dt>
                                                                <dd class="col-8">AD202603040001</dd>
                                                            </dl>
                                                        </div>
                                                        <div class="col">
                                                            <dl class="row mb-0">
                                                                <dt class="col-4">面試人選</dt>
                                                                <dd class="col-8">龔祥正</dd>
                                                            </dl>
                                                        </div>
                                                    </div>
                                                    <div class="row row-cols-md-2 row-cols-1">
                                                        ...
                                                        <div class="col">
                                                            <dl class="row mb-0">
                                                                ...
                                                                <dd class="col-8 text-muted">
                                                                    使用 display: grid 時，您可以在父層的 grid 容器加上 gap
                                                                    通用類別。這可以省去在單個網格線（display: grid 容器的子項）上使用 margin
                                                                    通用類別。Gap 通用類別預設具有響應式，並且根據 $spacers Sass map 通用類別 API
                                                                    產生。使用 display: grid 時，您可以在父層的 grid 容器加上 gap
                                                                    通用類別。這可以省去在單個網格線（display: grid 容器的子項）上使用 margin
                                                                    通用類別。Gap 通用類別預設具有響應式，並且根據 $spacers Sass map 通用類別 API
                                                                    產生。使用 display: grid 時，您可以在父層的 grid 容器加上 gap
                                                                    通用類別。這可以省去在單個網格線（display: grid 容器的子項）上使用 margin
