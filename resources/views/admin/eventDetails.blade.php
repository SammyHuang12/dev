...
<body data-topbar="dark">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="static/picture/logo-sm.png" alt="logo-sm-light" height="22">
                            </span>
                            <span class="logo-lg">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-none d-sm-inline-block">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            ...
                            <img class="" src="static/picture/us.jpg" alt="Header Language" height="16">
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="static/picture/spain.jpg" alt="user-image" class="me-1" height="12"> <span
                                    class="align-middle">Spanish</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="static/picture/germany.jpg" alt="user-image" class="me-1" height="12"> <span
                                    class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="static/picture/italy.jpg" alt="user-image" class="me-1" height="12"> <span
                                    class="align-middle">Italian</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="static/picture/russia.jpg" alt="user-image" class="me-1" height="12"> <span
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <div data-simplebar="" style="max-height: 230px;">
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="d-flex">
                                        <img src="static/picture/avatar-3.jpg" class="me-3 rounded-circle avatar-xs"
                                            alt="user-pic">
                                        <div class="flex-1">
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="d-flex">
                                        <img src="static/picture/avatar-4.jpg" class="me-3 rounded-circle avatar-xs"
                                            alt="user-pic">
                                        <div class="flex-1">
                                            ...
                                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-title-desc">Here are examples of <code
                                                        ...
                                                        each
                                                        textual HTML5 <code
                                                            class="highlighter-rouge">&lt;input&gt;</code> <code
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="password"
                                                                        value="hunter2" id="example-password-input">
                                                                </div>
                                                            </div>
                                                            <!-- end row -->
                                                        </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="month"
                                                                        value="2022-03" id="example-month-input">
                                                                </div>
                                                            </div>
                                                            <!-- end row -->
                                                        </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="week"
                                                                        value="2022-W14" id="example-week-input">
                                                                </div>
                                                            </div>
                                                            <!-- end row -->
                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 ms-auto">
                                                                            <div class="mt-4 mt-lg-0">
                                                                                ...
                                                                                <div>
                                                                                    <div
                                                                                        class="form-check form-check-right mb-3">
                                                                                        <input class="form-check-input"
                                                                                            type="checkbox"
                                                                                            id="formCheckRight1">
                                                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-check form-switch mb-3" dir="ltr">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="customSwitch1">Toggle this switch
                                                                            element</label>
                                                                    </div>
                                                                    <div class="form-check form-switch" dir="ltr">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="customSwitch2">Disabled switch
                                                                            element</label>
                                                                    </div>
    ...
    <div class="right-bar">
        <div data-simplebar="" class="h-100">
            ...
            <div class="p-4">
                <div class="mb-2">
                    <img src="static/picture/layout-1.jpg" class="img-fluid img-thumbnail" alt="layout-1">
                </div>
                ...
                <div class="mb-2">
                    <img src="static/picture/layout-2.jpg" class="img-fluid img-thumbnail" alt="layout-2">
                </div>
                <div class="form-check form-switch mb-3">
                ...
                <div class="mb-2">
                    <img src="static/picture/layout-3.jpg" class="img-fluid img-thumbnail" alt="layout-3">
                </div>
    ...
    <script src="static/js/form-element.init.js"></script>
